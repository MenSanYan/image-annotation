function [U_final, V_final, nIter_final, objhistory_final] = GNMF_V(X, k, W, options, U, V)
...
switch lower(options.Optimization)
    case {lower('Multiplicative')} 
        [U_final, V_final, nIter_final, objhistory_final] = GNMF_Multi_updateV(X, k, W, options, U, V);
    otherwise
