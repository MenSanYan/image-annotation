function [U_final, V_final, nIter_final, objhistory_final] = GNMF_single_view(X, k, Wr, Wi, options, U, V)%X, k, Wr, Wi, options, U, V
...
switch lower(options.Optimization)
    case {lower('Multiplicative')} 
        [U_final, V_final, nIter_final, objhistory_final] = GNMF_Multi_with_labelinf_single_view(X, k, Wr, Wi, options, U, V);
    otherwise
